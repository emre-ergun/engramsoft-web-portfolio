...
export default function Hero() {
  ...
  return (
    ...
    >
      <div className='flex items-center justify-center mb-12 sm:mb-10'>
      ...
      >
        <div className='flex flex-col sm:flex-row gap-2'>
          <a
            href='#contact'
            className='group bg-gray-900 text-white px-7 py-3 flex items-center justify-around gap-2 rounded-2xl outline-none hover:scale-105 hover:bg-gray-950 active:scale-100 transition'
            onClick={() => {
          ...
          <a
            href='/CV.pdf'
            download
            className='group bg-white px-7 py-3 flex items-center justify-around gap-2 rounded-2xl borderBlack outline-none hover:scale-105 active:scale-100 transition dark:bg-white/10'
          >
            Download CV{' '}
